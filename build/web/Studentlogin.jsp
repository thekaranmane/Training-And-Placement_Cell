<%-- 
    ...
    Created on : 9 May, 2022, 11:21:18 PM
    Author     : karan Mane
--%>
            ...
            <table border="0">
                ...
                <tr>
                    ...
                    <form name="form_login" action="valid_login.jsp" method="post" onsubmit="return valid_form();">
                        <table border="0" align="center" cellpadding="2" cellspacing="2">
                               <h2 align="center">Student Login here</h2>
                            <tr>
                            ...
                            <tr>
                                <td align="center" colspan="4">
                                    ...
                                    <input type="submit" name="submit" value="Register" class="btn">//change by me 
                                </td>
                            </tr>
                        </table>
                    </form>
                ...
                <tr>
                    <table border="0" width="100%" height="100%">
                       ...
                       <tr>
                          <td class="footer">
                            <h3>Developed by :Shruti Nitin Bhongale & Karan Mohan Mane </h3>
                          </td>
                       </tr>
                    </table>
                </tr>
