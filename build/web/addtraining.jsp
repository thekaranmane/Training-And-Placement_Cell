    ...
    <body>
            ...
            <table border="0">
                ...
                <tr>
                    ...
                    <form name="form_insert" action="insertraining.jsp" method="post" onsubmit="return insvalid();">
                        <table border="0" align="center">
                            <tr>
                                   <td class="lbl_txt">Training Name :</td>
                                   <td><input type="text" name="Trainingname" class="txt" /></td>
                               </tr>
                               <tr>
                                   <td class="lbl_txt">Training Date :</td>
                                   <td><input type="Date" name="Trainingdate" class="txt" /></td>
                               </tr>
                               <tr>
                               ...
                               <tr>
                                   <td class="lbl_txt">Lecturer :</td>
                                   <td><input type="text" name="Lecturer" class="txt" /></td>
                               </tr>
                               <tr>
                                   <td class="lbl_txt">About Training:</td>
                                   <td><input type="text" name="Abouttraining" class="txt" /></td>
                               </tr>
                               ...
                               <tr>
                                 <td align="center" colspan="2">
                                    <a href="viewtraining.jsp">View Records</a>
                                 </td>
                               </tr>
                        </table>                   
                    </form>
