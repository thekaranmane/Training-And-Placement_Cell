            ...
            <table border="0">
                ...
                <tr>
                    ...
                    <table border="0" align="center" cellpadding="2" cellspacing="2">
                        <tr class="Trainingname">
                            <td><div align="center"><strong>Trainingid</strong></div></td>
                             <td><div align="center"><strong>Trainingname</strong></div></td>
                            <td><div align="center"><strong>Trainingdate </strong></div></td>
                            
                            <td><div align="center"><strong>Lecturer</strong></div></td>
                            <td><div align="center"><strong>Abouttraining</strong></div></td>
...
;
                        ...
                        <tr class="viewefield">
                            ...
                            <td><%= rs.getString("Abouttraining") %></td>
                        ...
                        <tr>
                          <td class="footer">
                            <ul class="footer_ul">
                              <li><a href="index.jsp">Home</a></li>
                        <li><a href="About.jsp">About</a></li>
                         <li><a href="  .jsp">All Training</a></li>
                          <li><a href=" .jsp">All Jobs </a></li>
                          <li><a href="Contact.jsp">Contact Us</a></li>
