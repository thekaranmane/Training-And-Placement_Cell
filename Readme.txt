> This project is connection between jsp to mysql database.It is a Proccess on the project is store information
into mysql database and retrive data into database.They can be perform operation Like insert,update,delete and 
